...
<template>
  <div class="max-w-300 mx-auto">
    <p text-center mt--6 mb5 op50 text-lg italic>
      Products that I created or maintaining.
    </p>
    <div
      ...
      >
        ...
        >
          <div v-if="item.icon" class="pt-2 pr-5">
            ...
            <LinHan v-else-if="item.icon === 'af'" class="text-4xl opacity-50" />
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <div block mt-5>
        <a href="https://github.com/LinHanlove?tab=repositories" target="_blank" op50>All projects sort by Stars</a>
      </div>
      <hr>
      <SponsorButtons />
    </div>
